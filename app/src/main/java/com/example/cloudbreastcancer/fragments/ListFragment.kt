package com.example.cloudbreastcancer.fragments
...
import com.example.cloudbreastcancer.adapter.ClassificationRecyclerViewAdapter
import com.example.cloudbreastcancer.R
...
class ListFragment : Fragment() {
    ...
    override fun onResume() {
        super.onResume()
        (root as RecyclerView).adapter = ClassificationRecyclerViewAdapter(model.listHeartDisease(), mListener!!)
    }
    ...
    interface OnListFragmentInteractionListener {
        fun onListFragmentInteraction(item: HeartDiseaseVO)
    }
}
