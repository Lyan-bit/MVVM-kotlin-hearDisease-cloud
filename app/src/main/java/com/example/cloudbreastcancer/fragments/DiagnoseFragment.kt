...
import com.example.cloudbreastcancer.usecase.DiagnoseBean
...
class DiagnoseFragment : Fragment(), View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        Log.i("model1",model.listHeartDisease().toString())
        Log.i("model1",model.allHeartDiseaseids().toString())
        diagnoseListItems = model.allHeartDiseaseids()
